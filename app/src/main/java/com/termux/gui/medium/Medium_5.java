...
import static com.termux.gui.OpenMediumLevel.changeImageIcon5M;

/**
 * Created by Admin on 20/03/2017.
 */

public class Medium_5 extends Activity {
    ...
    public void submitMedium_5(View view) {
        ...
        if (flag == 0) {
            do {
                ...
                if (new String("61.110.9.105").equals(password)) {
                    if ((count != 0) && (count1 != 0)) {
                        //For Rest of the time
                        //if answer is correct
                        Log.i("Password_medium_5_1", password);
                        //Answer Check
                        Toast.makeText(this, "Level Cleared..Redirecting to Next Level", Toast.LENGTH_LONG).show();
                        Intent intent1 = new Intent(this, Medium_Cleared.class);
                        ...
                        //Answer Check
                        //Set Score
                        String score = "Medium_5";
                        Log.i("Medium3", "Entered submit");
                        ...
                        if (flag1 == 0) {
                            ...
                            sh.changeLevelCleared("M5", this);
                            Toast.makeText(this, "Level Cleared....Redirecting to Next Level", Toast.LENGTH_LONG).show();
                            SharedPreferences.Editor ed0 = Counter_Medium2.edit();
                            ed0.putString("count", "1");
                            ed0.commit();

                            //Change icon of level 5 -> lock to key
                            changeImageIcon5M();

                            Intent intent3 = new Intent(this, Medium_Cleared.class);
