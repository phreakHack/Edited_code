...
import static com.termux.gui.OpenMediumLevel.changeImageIcon3M;

/**
 * Created by Admin on 20/03/2017.
 */

public class Medium_3 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        levelCleared = sharedpreferenceuse.checkLevel("M2",this);
        if (levelCleared == 0) {
            flag = 0;
        }else {
            flag=1;
    ...
    public void submitMedium_3(View view) {
        ...
        if (flag == 0) {
            do {
                ...
                if (new String("Bxdjrioosdbioasj").equals(password)) {
                    if ((count != 0) && (count1 != 0)) {
                        //For Rest of the time
                        //if answer is correct
                        Log.i("Password_medium_3_1", password);
                        //Answer Check
                        Toast.makeText(this, "Level Cleared..Redirecting to Next Level", Toast.LENGTH_LONG).show();
                        Intent intent1 = new Intent(this, Medium_4.class);
                        ...
                        if (flag1 == 0) {
                            ...
                            Intent intent3 = new Intent(this, Medium_4.class);
