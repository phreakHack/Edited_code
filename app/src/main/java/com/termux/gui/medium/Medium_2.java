...
import static com.termux.gui.OpenMediumLevel.changeImageIcon2M;

/**
 * Created by Admin on 20/03/2017.
 */

public class Medium_2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        levelCleared = sharedpreferenceuse.checkLevel("M1",this);
        if (levelCleared == 0) {
            flag = 0;
        }else {
            flag=1;
    ...
    public void submitMedium_2(View view) {
            ...
            do {
                ...
                if (new String("Whfvkojndnlmsdf").equals(password)) {
                    if ((count != 0) && (count1 != 0)) {
                        ...
                        //Answer Check
                        //Set Score
                        String score = "Medium_2";
                        Log.i("Medium2", "Entered submit");
