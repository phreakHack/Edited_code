...
import static com.termux.gui.OpenMediumLevel.changeImageIcon1M;

/**
 * Created by Admin on 20/03/2017.
 */

public class Medium_1 extends Activity {
...
//        }
    ...
    public void submitMedium_1(View view){
        ...
        do {
            ...
            count1 = Integer.parseInt(countfromSP1);
                ...
                if(new String("192.124.249.10").equals(password)) {
                    if((count!=0) &&(count1!=0)){
                //For Rest of the time
                //if answer is correct
                Log.i("Password_medium_1_1",password);
                //Answer Check
                    Toast.makeText(this, "Level Cleared..Redirecting to Next Level", Toast.LENGTH_LONG).show();
                    Intent intent1 = new Intent(this, Medium_2.class);
                ...
                if (flag == 0) {
                    ...
                    //Answer Check
                        //Set Score
                        String score = "Medium_1";
                        Log.i("Medium1", "Entered submit");
                        ...
                        if (flag1 == 0) {
                            ...
                            Intent intent3 = new Intent(this,Medium_2.class);
