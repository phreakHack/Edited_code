...
import static com.termux.gui.OpenHardLevel.changeImageIcon1H;
import static com.termux.gui.OpenHardLevel.changeImageIcon2H;
import static com.termux.gui.OpenHardLevel.changeImageIcon3H;

/**
 * Created by Admin on 20/03/2017.
 */

public class Hard_1 extends Activity {
...
//        }
   ...
   public void submitHard_1(View view){
       ...
       do {
           ...
           if(new String("rabjdfkdsgfjkjg").equals(password)) {
               if((count!=0) &&(count1!=0)){
                   //For Rest of the time
                   //if answer is correct
                   Log.i("Password_hard_1_1",password);
                   //Answer Check
                   ...
                   if (flag == 0) {
                       ...
                       if (flag1 == 0) {
                           ...
                           //level 2 and 3 don't have submit answer, hence will be opened after completing H1
                           changeImageIcon2H();
                           changeImageIcon3H();
