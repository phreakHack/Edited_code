...
import static com.termux.gui.OpenEasyLevel.changeImageIcon4E;

public class Easy_4 extends Activity {
    ...
    public void submitEasy_4(View view){
        ...
        if (flag == 0) {
            do {
                ...
                if (new String("25130244").equals(password)) {
                    if ((count != 0) && (count1 != 0)) {
                        //For Rest of the time
                        //if answer is correct
                        Log.i("Password_easy_4_1", password);
                        //Answer Check
                        Toast.makeText(this, "Level Cleared..Redirecting to Next Level", Toast.LENGTH_LONG).show();
                        Intent intent1 = new Intent(this, Easy_5.class);
                        ...
                        if (flag1 == 0) {
                            ...
                            Intent intent3 = new Intent(this, Easy_5.class);
