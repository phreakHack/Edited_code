...
import static com.termux.gui.OpenEasyLevel.changeImageIcon9E;

public class Easy_9 extends Activity {
    ...
    public void submitEasy_9(View view){
        ...
        if (flag == 0) {
            do {
                ...
                if (new String("cybersecurity").equals(password)) {
                    if ((count != 0) && (count1 != 0)) {
                        //For Rest of the time
                        //if answer is correct
                        Log.i("Password_easy_9_1", password);
                        //Answer Check
                        Toast.makeText(this, "Level Cleared..Redirecting to Next Level", Toast.LENGTH_LONG).show();
                        Intent intent1 = new Intent(this, Easy_10.class);
                        ...
                        if (flag1 == 0) {
                            ...
                            Intent intent3 = new Intent(this, Easy_10.class);
