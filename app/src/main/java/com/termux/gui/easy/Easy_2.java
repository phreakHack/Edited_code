...
import static com.termux.gui.OpenEasyLevel.changeImageIcon2E;

public class Easy_2 extends Activity {
    ...
    public void submitEasy_2(View view){
        ...
        if (flag == 0) {
            do {
                ...
                if (new String("apropos").equals(password)) {
                    if ((count != 0) && (count1 != 0)) {
                        //For Rest of the time
                        //if answer is correct
                        Log.i("Password_easy_2_1", password);
                        //Answer Check
                        Toast.makeText(this, "Level Cleared..Redirecting to Next Level", Toast.LENGTH_LONG).show();
                        Intent intent1 = new Intent(this, Easy_3.class);
