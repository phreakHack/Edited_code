...
import static com.termux.gui.OpenEasyLevel.changeImageIcon1E;

public class Easy_1 extends Activity {
    ...
    private static ImageView imageViewE1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageViewE1 = (ImageView)findViewById(R.id.levelE_1_imageview);
        //int levelCleared = 0;
     //   SharedPreferenceUse sharedpreferenceuse = new SharedPreferenceUse();
        //levelCleared = sharedpreferenceuse.checkLevel("1", this);
       // if (levelCleared == 0) {
            flag = 0;
        //} else {
          //  flag = 1;
    ...
    public void submitEasy_1(View view){
        ...
        if (flag == 0) {
            do {
                ...
                if (new String("kalihackummins").equals(password)) {
                    if ((count != 0) && (count1 != 0)) {
                        //For Rest of the time
                        //if answer is correct
                        Log.i("Password_easy_1_1", password);
                        //Answer Check
                        Toast.makeText(this, "Level Cleared..Redirecting to Next Level", Toast.LENGTH_LONG).show();
                        Intent intent1 = new Intent(this, Easy_2.class);
                        ...
                        if (flag1 == 0) {
                            ...
                            //Change icon of level 1 -> lock to key
                                changeImageIcon1E();
                            //Go to Next Activity
                            Intent intent3 = new Intent(this, Easy_2.class);
