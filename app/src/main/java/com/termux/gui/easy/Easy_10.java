...
import static com.termux.gui.OpenEasyLevel.changeImageIcon10E;

public class Easy_10 extends Activity {
    ...
    public void submitEasy_10(View view){
        ...
        if (flag == 0) {
            do {
                ...
                if (new String("10691").equals(password)) {
                    if ((count != 0) && (count1 != 0)) {
                        //For Rest of the time
                        //if answer is correct
                        Log.i("Password_easy_10_1", password);
                        //Answer Check
                        Toast.makeText(this, "Level Cleared..Redirecting to Next Level", Toast.LENGTH_LONG).show();
                        Intent intent1 = new Intent(this, Easy_Cleared.class);
                        ...
                        if (flag1 == 0) {
                            ...
                            sh.changeLevelCleared("E10", this);
                            Toast.makeText(this, "Level Cleared....Redirecting to Next Level", Toast.LENGTH_LONG).show();
                            SharedPreferences.Editor ed0 = Counter_Medium2.edit();
                            ed0.putString("count", "1");
                            ed0.commit();

                            //Change icon of level -> lock to key
                            changeImageIcon10E();

                            Intent intent3 = new Intent(this, Easy_Cleared.class);
